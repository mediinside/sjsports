								...
								<ul>
									<li class="dp2<?php if($locArr[0] == "3" && $locArr[1] == "1") echo " current"?>">
										...
										<div class="dp-section">
											...
											<ul>
												<li class="dp3<?php if($locArr[0] == "3" && $locArr[1] == "1" && $locArr[2] == "1") echo " current"?>"><a href="/spine/waist/page01.html"><span>허리디스크<small>(요추 추간판탈출증)</small></span></a></li>
												<li class="dp3<?php if($locArr[0] == "3" && $locArr[1] == "1" && $locArr[2] == "2") echo " current"?>"><a href="/spine/waist/page02.html"><span>척추관협착증</span></a></li>
												<li class="dp3<?php if($locArr[0] == "3" && $locArr[1] == "1" && $locArr[2] == "3") echo " current"?>"><a href="/spine/waist/page03.html"><span>척추전방전위증</span></a></li>
												<li class="dp3<?php if($locArr[0] == "3" && $locArr[1] == "1" && $locArr[2] == "4") echo " current"?>"><a href="/spine/waist/page04.html"><span>척추분리증</span></a></li>
												<li class="dp3<?php if($locArr[0] == "3" && $locArr[1] == "1" && $locArr[2] == "5") echo " current"?>"><a href="/spine/waist/page05.html"><span>척추측만증</span></a></li>
												<li class="dp3<?php if($locArr[0] == "3" && $locArr[1] == "1" && $locArr[2] == "6") echo " current"?>"><a href="/spine/waist/page06.html"><span>디스크내장증</span></a></li>
												<li class="dp3<?php if($locArr[0] == "3" && $locArr[1] == "1" && $locArr[2] == "7") echo " current"?>"><a href="/spine/waist/page07.html"><span>척추압박골절</span></a></li>
												<li class="dp3<?php if($locArr[0] == "3" && $locArr[1] == "1" && $locArr[2] == "8") echo " current"?>"><a href="/spine/waist/page08.html"><span>강직성척추염</span></a></li>
											</ul>
										</div>
									</li>
									<li class="dp2<?php if($locArr[0] == "3" && $locArr[1] == "2") echo " current"?>">
										...
										<div class="dp-section">
											...
											<ul>
												<li class="dp3<?php if($locArr[0] == "3" && $locArr[1] == "2" && $locArr[2] == "1") echo " current"?>"><a href="/spine/neck/page01.html"><span>목디스크<small>(경추 추간판탈출증)</small></span></a></li>
												<li class="dp3<?php if($locArr[0] == "3" && $locArr[1] == "2" && $locArr[2] == "2") echo " current"?>"><a href="/spine/neck/page02.html"><span>거북목증후군</span></a></li>
												<li class="dp3<?php if($locArr[0] == "3" && $locArr[1] == "2" && $locArr[2] == "3") echo " current"?>"><a href="/spine/neck/page03.html"><span>근막통증증후군</span></a></li>
												<li class="dp3<?php if($locArr[0] == "3" && $locArr[1] == "2" && $locArr[2] == "4") echo " current"?>"><a href="/spine/neck/page04.html"><span>후종인대골화증</span></a></li>
											</ul>
										</div>
									</li>
								</ul>
