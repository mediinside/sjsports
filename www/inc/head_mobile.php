...
<head>
	...
	<meta name="keywords" content="세종스포츠정형외과">
	<meta name="description" content="세종스포츠정형외과">
	<meta property="og:type" content="website">
	<meta property="og:title" content='세종스포츠정형외과'>
	<meta property="og:description" content='세종스포츠정형외과'>
	<meta property="og:image" content="사용될 이미지 경로">
	...
	<link rel="stylesheet" href="/public/css/mobile/default.css">
	<link rel="stylesheet" href="/public/css/mobile/main.css">
	<link rel="stylesheet" href="/public/css/mobile/style.css?<? print $ver ?>">
	<!-- //CSS -->
	...
	<script src="/public/js/mobile/script.js?<? print $ver ?>"></script>


	<!-- JAVASCRIPT -->
	<script src="/public/js/mobile/common_front.js"></script>
	<script src="/public/js/mobile/ui.js"></script>
	<script src="/public/js/mobile/pub.js"></script>
	<script src="/public/js/mobile/libs/jquery.scrollbar.min.js"></script>
	<script src="/public/js/mobile/libs/swiper.min.js"></script>
	<script src="/public/js/mobile/libs/TweenMax.min.js"></script>
	<!-- //JAVASCRIPT -->
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-137499720-1"></script>
	<script>
	window.dataLayer = window.dataLayer || [];
	function gtag(){dataLayer.push(arguments);}
	gtag('js', new Date());

	gtag('config', 'UA-137499720-1');
	</script>
...
(function(win,name){
	...
	<![endif]-->
	<!-- LOGGER(TM) TRACKING SCRIPT V.40 FOR logger.co.kr / 102131 : COMBINE TYPE / DO NOT ALTER THIS SCRIPT. -->
	<script type="text/javascript">var _TRK_LID = "102131";var _L_TD = "ssl.logger.co.kr";var _TRK_CDMN = ".samsungbon.com";</script>
	<script type="text/javascript">var _CDN_DOMAIN = location.protocol == "https:" ? "https://fs.bizspring.net" : "http://fs.bizspring.net";
	(function (b, s) { var f = b.getElementsByTagName(s)[0], j = b.createElement(s); j.async = true; j.src = '//fs.bizspring.net/fs4/bstrk.1.js'; f.parentNode.insertBefore(j, f); })(document, 'script');
	</script>
	<noscript><img alt="Logger Script" width="1" height="1" src="http://ssl.logger.co.kr/tracker.1.tsp?u=102131&js=N"/></noscript>
	<!-- END OF LOGGER TRACKING SCRIPT -->

	<style>
		.view>li:nth-child(1) .bg span {
			background-image: url('/public/images/main/msjs_vi_img001.jpg');
		}
