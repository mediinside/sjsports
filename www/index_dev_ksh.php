...
?>
	...
	<div class="visual-wrap">
		...
		<div class="info-wrap">
			...
			<div class="inner">
				<ul class="text">
					<li class="on">일상의 걸음도 스포츠다! 세종스포츠정형외과</li>
					<li><!--다시 뛸 수 있을까?--> 더 완벽해지기 위해서</li>
					<li><!--다시 던질 수 있을까?--> 더 나아지기 위해서</li>
	...
	<div class="contents">
		<div class="main_4">
			<div class="pre_footer py30">
				...
				<style>
					.main_4 .pre_footer .pre_footer_1 { width: 32%; height: 200px; float: left; overflow: hidden; position: relative; border-right: 0 !important; padding-right: 0; }
					.main_4 .pre_footer .pre_footer_1 .info_agree { position: absolute; top: 0; right: 0; padding-right: 0; }
					.main_4 .pre_footer .pre_footer_2 { width: 24%; height: 200px; float: left; border-right: 1px solid #c7c7c7; /* margin-right: 30px; */ padding: 0 20px; }
					.main_4 .pre_footer .pre_footer_3 { width: 44%; height: 200px; float: left; padding: 0 20px; }
				</style>
