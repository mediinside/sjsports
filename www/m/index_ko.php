  ...
  <div class="main_slide">
  	<div class="swiper-container gallery-top">
  	    <div class="swiper-wrapper">
  	        <div class="swiper-slide" style="background-image:url('/public/images/mobile/main/msjs_vi_img005.jpg')">
				<div class="text-wrap type02 ">
	                <div class="text-wrap">
		                <span class="text-top">세종스포츠정형외과는<br/>여러분이 건강한 삶으로 돌아가는</span>
						<em><span class="greenTxt">되감기 버튼</span>이<br/>되어드리겠습니다.</em>
						<div class="txtImg mt100"><img src="/public/images/mobile/main/mainVisu_img02.png" alt=""/></div>
  	        ...
  	        <div class="swiper-slide" style="background-image:url('/public/images/mobile/main/msjs_vi_img006.jpg')">
				<div class="text-wrap type02">
					<div class="txtImg"><img src="/public/images/mobile/main/mainVisu_img01.png" alt=""/></div>
	                <span class="text-top">스포츠 손상, 관절·척추 통증치료,<br/>비수술적 치료부터 고난이도 수술까지!</span>
					<em>
						<span class="greenTxt">결과의 차이</span>를 만드는<br/> 
							세종스포츠정형외과
					</em>
					<a href="/m/about/sub02.php" class="main_view_more">View more +</a>
				</div>
				<div class="main_slide_ctrl">
  	        ...
  	        <div class="swiper-slide" style="background-image:url('/public/images/mobile/main/msjs_vi_img007.jpg')">
				<div class="text-wrap type02">
					<div class="txtImg"><img src="/public/images/mobile/main/mainVisu_img01.png" alt=""/></div>
	                <span class="text-top">프로가 치료하는 병원은 다릅니다.!</span>
					<em><span class="greenTxt">프로</span>가<br/>치료하는 병원</em>
					<a href="/m/about/sub04.php" class="main_view_more">View more +</a>
				</div>
				<div class="main_slide_ctrl">
					<p>sejong sports</p>
					<em><a href="#here"><img src="/public/images/mobile/main/scroll_ico.png" style="width: 90%"></a></em>
...
<!-- 하단 QUICK -->
	<div class="quick">
		...
		<ul class="quick_lit list-unstyled">
			<!-- <li class='p30 border_custom_left'><a href="/m/club/page01.php">병원소식</a></li>
			<li class='p30 border_custom_left'><a href="/m/club/page01.php">전문의상담</a></li> -->
			<li class='p30 border_custom_left'><a href="/m/about/sub02.php">의료진소개</a></li>
			<li class='p30 border_custom_left'><a href="/m/info/sub01.php">진료시간</a></li>
			<li class='p30 border_custom_left'><a href="/m/club/page03.php">SJS TV</a></li>
			<li class='p30 border_custom_left'><a href="/m/club/page04.php">치료후기</a></li>
		</ul>
	</div>
	<!-- //하단 QUICK -->
	...
	<?php include_once $GP -> INC_WWW . '/footer_mobile_ko.php'; ?>
