...
if($cate1 == 1){
	$cate2_select = $C_Func -> makeSelect_Normal('cate2', $GP -> NONPAY_CATE_TYPE1_1, $_GET['cate2'], ' title="카테고리2" class="search-detail-scope"  ', '');
}else if($cate1 == 2){
	$cate2_select = $C_Func -> makeSelect_Normal('cate2', $GP -> NONPAY_CATE_TYPE1_2, $_GET['cate2'], ' title="카테고리2" class="search-detail-scope"  ', '');
}else if($cate1 == 3){
	$cate2_select = $C_Func -> makeSelect_Normal('cate2', $GP -> NONPAY_CATE_TYPE1_3, $_GET['cate2'], ' title="카테고리2" class="search-detail-scope"  ', '');
}
?>
<script>
			...
			<div class="contain">
				<form class="board-search nonpay" id="frm_search" name="frm_search" method="get" action="?">
					<fieldset>
						...
						<select name="cate1" id="cate1" class="search-scope">
