  ...
  <div class="main_slide">
  	<div class="swiper-container gallery-top">
  	    <div class="swiper-wrapper">
  	        <div class="swiper-slide" style="background-image:url('/public/images/mobile/main/mv01.jpg')">
				<div class="text-wrap">
  	        ...
  	        <div class="swiper-slide" style="background-image:url('/public/images/mobile/main/mv02.jpg')">
				<div class="text-wrap">
  	        ...
  	        <div class="swiper-slide" style="background-image:url('/public/images/mobile/main/mv03.jpg')">
				<div class="text-wrap">
  	        ...
  	        <div class="swiper-slide" style="background-image:url('/public/images/mobile/main/mv04.jpg')">
				<div class="text-wrap">
