		...
		<div class="contents_body">
			<div class="box_style_1 text-center py60 px30">
				...
				<p class="mt20">
					...
					성별을 살펴보면 여성의 경우 남성에 비해 약 25배 정도로 단지증 증상이 나타나며, 인구 약 만명당 1명꼴로 발생하는 것으로 알려져 있습니다.</p>
				<div class="mt30"><img src="/public/images/common/foot_sub07_img01.jpg" alt="" style="width: 70%"></div>
			</div>
				...
				<div class="box_style_2_div box_style_2_div_left" style="background-image: url('/public/images/common/foot_sub07_img02.jpg');">
					...
					<div>
						<ul class="box_style_2_ul">
							...
							<li class="">발생원인이 명확하지 않은 것이 특징</li>
						</ul>
					</div>
				</div>
			...
			<div class="box_style_4 px30 pb50">
				...
				<div class="box_style_4_body pt30">
					<iframe class="box_style_4_mov_file" src="https://www.youtube.com/embed/3nSFiBE8F84" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
			</div>
			...
			<div class="box_style_5 py40 px30" style="background-image: url('/public/images/common/img_06.jpg');">
				...
				<ul class="box_style_5_ul mt50">
					<li class="p30">
						<h4><strong class="mt10"><span class="text-hide">1. </span></strong></h4>
						<p>선천성 기형의 경우<br/>예방방법이 없습니다.</p>
					</li>
					<li class="p30">
						<h4><strong class="mt10"><span class="text-hide">2. </span></strong></h4>
						<p>수술적치료만 가능한 질환이기 때문에<br/>발의 성장이 끝난 성인만 가능합니다.</p>
					</li>
					<li class="p30">
						<h4><strong class="mt10"><span class="text-hide">3. </span></strong></h4>
