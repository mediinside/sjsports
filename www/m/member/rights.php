...
<div id="container">
	<div class="deco-header">
		<p class="highlight"><strong>환자권리장전</strong></p>
		<p class="decoration tup">Patient Bill of Rights</p>
	</div>
	<div id="article" class="publish">
		<div class="contain">
			<?php include_once "../../member/publish-rights.txt"; ?>
		</div>
	</div>
</div>
