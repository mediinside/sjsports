...
<div id="container">
	<div class="deco-header">
		<p class="highlight"><span>세종스포츠정형외과에</span> <br class="mb-show" /><strong>오신것을 환영합니다.</strong></p>
	</div>
	<div id="article">
		<div class="contain">
			<div id="sign-in">
				...
				<div class="panel">
					<ul class="other-process">
						...
						<!-- <li><a href="javascript:alert('준비중입니다.')"  class="btn sns-signin">
							<i class="bicon-facebook-ci"></i>
							<span>로그인</span>
						</a></li> -->
						<!-- <li><a href="/member/join.html" id="mem_register" class="btn btn-go2signup"><span>회원가입</span></a></li> -->
						<!-- <li><a href="/member/idpw.html" class="btn btn-forget"><span>아이디 / 비밀번호 찾기</span></a></li> -->
					</ul>
				</div>
			</div>
		</div>
