					...
					<ul class="list">
						...
						<li><div class="panel">
							...
							<dl class="info">
								...
								<dd>현재 공사중입니다. 스포츠 손상 등 근골격계 손상을 정확하게<br/>진단하고자 3.0테슬라의 고급사양을 설치하였습니다.<br/>손상에 대한 맞춤형 축상을 촬영하여 진단율을 높이기 위한<br/>노력을 하고 있습니다.</dd>
							</dl>
						</div></li>
						<li><div class="panel">
						...
						<li><div class="panel">
							...
							<dl class="info">
								<dt>관절경 장비</dt>
								<dd>Arthrex Synergy FHD 2대 각 관절경수술방에 위치하여,<br/>이동없도록 하여 감염의 위험성을 최소화 하였습니다. </dd>
							</dl>
						</div></li>
						<li><div class="panel">
							...
							<dl class="info">
								<dt>C-arm</dt>
								<dd>제노레이 Zen 9080 Pro. 이동형 방사선 장치이며,<br/>steady seller 모델입니다.</dd>
							</dl>
						</div></li>
						<li><div class="panel">
