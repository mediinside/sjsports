	...
	<div id="container" class="bg-scratch">
		...
		<div id="article" class="intro side-strip">
			...
			<div class="deco-quote">
				...
				<p class="highlight"><em><strong>일상의 걸음</strong>도 스포츠다</em></p>
				<p class="small">저희 병원은 급성기 운동손상부터 관절, 척추질환을 전문적으로 진단하고 치료를 시행하는 곳 입니다.<br/>운동을 하다 부상을 당하면 바로 생각나고, 치료 혹은 수술 후 일상으로의 복귀까지 최선을 다하는 병원이 되겠습니다.<br/><span style="font-weight:bold; color: #000">RTP(return to play, 원래 이전의 상태로 돌아감)</span>을 병원의 목표로 설정하였습니다.<br/>정확한 진단을 한 후, 신속하게 원래의 활동으로 복귀 할 수 있도록 치료하겠다는 의지입니다.<br/>또한, 치료는 개인에게 가장 적절한 증거 중심의 치료를 고집합니다.<br/>모든 사람들에게 사용되고, 알려져 있는 안전한 최선, 최신의 방법으로 치료를 합니다.<br/>치료이후 최대한 빠른 복귀를 위하여 <span style="font-weight:bold; color: #000">Sports Performance Center(SPC)</span>를 구성하여,<br/>진단, 치료, 수술, 재활, 기능적회복, 만성손상의 예방까지 포괄적인 의료를 담당할 것입니다.<br/>외래진료, 검사, 입원, 수술, 퇴원, 재활 등의 흐름을 직관화 하여 환자들이 방문했을 때<br/>정말 편리한 병원, 멋지고, 정직하고, <span style="font-weight:bold; color: #000">내선수, 내자식, 내부모</span>를 믿고 맡길 수 있는 안전한 병원이 되도록 하겠습니다.<br/>환자 여러분에게 진료 후 가벼운 걸음으로 돌아갈 수 있도록 최선을 다하겠습니다.<br/>대한민국을 대표하는 <span style="font-weight:bold; color: #000">스포츠 의학 병원</span>이 되겠습니다.</p>
			</div>
