					...
					<div class="contain">
						<ul class="traffic">
							<li><div class="panel">
								...
								<div class="section">
									<h5 class="station my20"><i style="display:inline-block;margin: 2px 5px;font-size: 16px;font-style: normal;font-weight: 400;line-height: 1.5em;letter-spacing: -0.025em;color: #fff;text-align: center;vertical-align: top;border-radius: 18px;background-color: #7e0fe8;padding: 2px 20px;">5호선</i><i class="line-1">7호선</i><strong class="station_nm">군자역</strong></h5>
							...
							<li><div class="panel">
								...
								<div class="section">
									<p>건국대학교 방향에서 오시는 경우에는 세종대학교 정문을 지난 후 U턴을 하여, 세종대학교 대양 AI 센터 지하 3층~5층 주차장을 이용하시면 됩니다.<br/><b style="color:#F00;">431대의 충분한 주차시설을 이용하실 수 있습니다.</b></p>
			...
			<div class="intro-parking">
				<div class="display">
					<div class="panel">
						...
						<p>- 세종스포츠정형외과는 방문객을 위하여 주차장을 2시간 무료로 운영하고 있습니다. <br class="mb-hide" />- 본 주차장은 무인주차 시스템으로 운영되고 있습니다. <br class="mb-hide" />- 입차 시   주차장 입구가 좁으니 주의 운전해주세요. <br class="mb-hide" />- 출차 시 금액이 발생하는 경우 카드로만 결제가 가능합니다.</p>
					</div>
					<div class="panel">
						<div class="notes">
							<dl class="header">
