	...
	<div id="container" class="bg-scratch">
		...
		<div id="article" class="intro side-strip">
			...
			<div class="deco-quote">
				...
				<p class="small">SPC는 빠른 복귀라는 기존 운동재활 목표의 미비함을 극복하기위해<br/><strong>“Return to Sports with Maximal erformance”</strong> 라는 새로운 패러다임 위에 설립되었습니다. <br />
...
<ul>
	...
	<li style="background-image: url('/public/images/common/img_about_sub04_2_3.jpg');">
		<div class="txt_area">
			...
			<p>
				무동력 트레이드밀은 사용자가 본인의 힘으로 벨트를 밀어내도록<br />
