	...
	<script>
		...
		function ctrl_pause(){
			...
			$('.swiper_main_2_ctrl .ctrl_play').show();
				...
				function nav_fixed(){
					var header_top_h = $('header').height();


					//var header_middle_h = $('.header_middle').height();
					var nav_cover_top = $('.nav_cover').offset().top;
					var window_top = $(window).scrollTop();
					console.log(header_top_h+" : "+ nav_cover_top +" : "+ window_top)

					if(100 < window_top){
						$('.nav_cover').addClass("fixed");
						$('body').addClass("header_fixed");
					}else{
						$('.nav_cover').removeClass("fixed");
...
<style>
	...
	.nav_cover.fixed{position: fixed; top: 0; left: 0; width: 100%;}
</style>
	<?php include_once $GP -> INC_WWW . '/header_ver3.php';?>
	<div class="visual-wrap">
		<ul class="view">
			<li class="on" onclick="location.href='/about/sub01.php'" style="cursor: pointer;">
				<div class="text-wrap">
                    <!-- <span class="text-top">sejong sports performance center</span>
                    					<em>일상의 걸음도 스포츠다!<br/>세종스포츠정형외과</em> -->
					<!-- <a href="/about/sub01.php" class="main_view_more">View more +</a> -->
				</div>

			</li>
			<li onclick="location.href='/about/sub02.php'" style="cursor: pointer;">
				<div class="text-wrap">
					<!-- <span class="text-top">for the perfection</span>
					<em>다시 뛸 수 있을까?<br/>더 완벽해지기 위해서</em> -->
					<!-- <a href="/about/sub02_detail.php?Drno=1" class="main_view_more">View more +</a> -->
				</div>
			</li>
			<li onclick="location.href='/about/sub04.php'" style="cursor: pointer;">
				<div class="text-wrap">
					<!-- <span class="text-top">make it better</span>
					<em>다시 던질 수 있을까?<br/>더 나아지기 위해서</em> -->
					<!-- <a href="/about/sub02_detail.php?Drno=3" class="main_view_more">View more +</a> -->
				</div>
			</li>
			<!-- <li>
				<div class="text-wrap">
					...
					<a href="/about/sub02_detail.php?Drno=2" class="main_view_more">View more +</a>
				</div>
			</li> -->
		</ul>
		<div class="info-wrap">
			...
			<div class="inner">
				<ul class="text" style="display: none;">
					<li class="on">되감기 버튼이 되어드리겠습니다.</li>
					<li>결과의 차이를 만드는 세종스포츠정형외과</li>
					<li>프로가 치료하는 병원</li>
					<!-- <li>다시 오를 수 있을까? 일상으로 돌아가는 그날까지</li> -->
				</ul>
			...
			<div class="pre_footer py30">
				...
				<div class="pre_footer_3">
					<ul class="ancher_list mt20 list-unstyled">
						<li><a href="/about/sub02.php"><i class="ancher_image"></i><span class="ancher_txt">의료진 소개</span></a></li>
						...
						<li><a href="/club/page04.php"><i class="ancher_image"></i><span class="ancher_txt">치료후기</span></a></li>
						<li class="d-none"><a href="#"><i class="ancher_image"></i><span class="ancher_txt">환지후기</span></a></li>
					</ul>
				</div>
					...
					<form class="contain" action="?" name="frm_ps" id="frm_ps" method="post">
						...
						<div class="info_agree pt20">
							<div class="custom-control custom-checkbox d-inline-block mr10">
								<input name="agree" type="checkbox" class="custom-control-input" id="custom-control-input-agree2">
								<label class="custom-control-label text_demilight" for="custom-control-input-agree2">개인정보 취급방침에 동의</label>
							</div>
						...
						<div class="form_box mt10">
							...
							<div class="main_councel">
								<button type="button" id="img_submit"  class="btn_main_councel" style="background-image: url('/public/images/common/councel_btn_img.jpg');"><span class="text-hide" onclick="_LA.EVT('4218')">상담신청</span></button>
							</div>
						</div>
					</form>
				</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$('#img_submit').click(function(){
				...
				if($('#tfc_type option:selected').val() == '')	{
