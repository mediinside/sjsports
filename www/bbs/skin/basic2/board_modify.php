<script type="text/javascript" src="<?=$GP -> JS_SMART_PATH2?>/HuskyEZCreator.js" charset="utf-8"></script>
   ...
   <table>
      ...
      <tr>
        ...
        <tr>
          ...
          <td>
          	<input type="text" class="i_text" title="페이지 URL" placeholder="페이지 URL을 입력해 주세요." id="jb_etc3" name="jb_etc3" value="<?=$jb_etc3;?>" />
          </td>
        </tr>
        <!--tr>
