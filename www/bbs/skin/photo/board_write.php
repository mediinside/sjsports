  ...
  <div class="board-write">
	<table>
      ...
      <tbody> 
          ...
          <td><input type="text" class="i-text datepicker" title="작성일자 입력" placeholder="작성일자를 입력해 주세요."id="jb_etc2" name="jb_etc2" /></td>
        </tr>  
        <tr>
          <th scope="row">매체명</th>
           <td><input type="text" class="i-text" title="매체명 입력" placeholder="매체명을 입력해 주세요." autocomplete="off" id="jb_type" name="jb_type" /></td>
        </tr>    	
        <tr>
          <th scope="row">제목</th>
        ...
        <!--tr>
          ...
          <td>
          	<input type="text" class="txt" title="발표일자 입력" placeholder="발표일자을 입력해 주세요." id="jb_etc2" name="jb_etc2" />
          </td>
        </tr-->
        <!--tr>
          <th scope="row">작성자</th>
        ...
        <tr>
          ...
          <td>
            ...
            ?>
            <label><input type="checkbox" class="chk" value="Y" id="jb_main_check" name="jb_main_check" />메인적용</label>
          </td>
        </tr>
        <tr>
