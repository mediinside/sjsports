   ...
   <table>
      ...
      <tr>
          ...
          <td><input type="text" class="i-text datepicker" title="작성일자 입력" placeholder="작성일자를 입력해 주세요."id="jb_etc2" name="jb_etc2" value="<?=$jb_etc2?>" /></td>
       	...
       	<tr>
          <th scope="row">매체명</th>
           <td><input type="text" class="i-text" title="매체명 입력" placeholder="매체명을 입력해 주세요." autocomplete="off" id="jb_type" name="jb_type" value="<?=$jb_type;?>"/></td>
        </tr>   
        <tr>
          <th scope="row">제목</th>
        ...
        <tr>
          ...
          <td>
            ...
            ?>
            <label><input type="checkbox" class="chk" value="Y" id="jb_main_check" name="jb_main_check" <?php if($jb_main_check == "Y") echo "checked";?> /> 메인적용</label>   	
          </td>
        </tr>
        <tr>
