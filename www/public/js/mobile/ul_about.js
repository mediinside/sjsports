...
$(document).ready(function(){
	...
	//헤더
	$('header .pc h1 a img').attr('src','/public/images/common/logo-main.png');
	$('header .util a img').attr('src','/public/images/common/btn-eng_w.png');
	$('.mo-search img').attr('src','/public/images/common/btn-search-m-w.png');
	$('.mo-gnb-open img').attr('src','/public/images/common/btn-menu-main-m.png');
	$('header .mobile .head h1 img').attr('src','/public/images/common/logo-main-m.png');
	$('#gnb ul > li').on('mouseover',function(){
		$('header').addClass('active');
		$('header .pc h1 a img').attr('src','/public/images/common/logo.png');
		$('header .util a img').attr('src','/public/images/common/btn-eng.png');
	});
	$(window).on('load scroll',function(){
		...
		if(top > 0){
			...
			$('header .pc h1 a img').attr('src','/public/images/common/logo.png');
			$('header .util a img').attr('src','/public/images/common/btn-eng.png');
			$('.mo-gnb-open img').attr('src','/public/images/common/btn-menu-m.png');
			$('.mo-search img').attr('src','/public/images/common/btn-search-m-b.png');
			$('header .mobile .head h1 img').attr('src','/public/images/common/logo-m.png');
