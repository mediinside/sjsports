...
?>
	...
	<div class="visual-wrap">
		<ul class="view">
			<li class="on">
				<div class="text-wrap"> <em>return to play! </em>
					<span>SPORTS PERFORMANCE CENTER - RETURN TO PLAY!</span>
				</div>
			</li>
			<li>
				<div class="text-wrap"> <em>'다시 던질 수 있을까?'</em>
					<span>SPORTS PERFORMANCE CENTER - RETURN TO PLAY!</span>
				</div>
			</li>
			<li>
				<div class="text-wrap"> <em>'다시 오를 수 있을까?'</em>
					<span>SPORTS PERFORMANCE CENTER - RETURN TO PLAY!</span>
				</div>
			</li>
			<li>
				<div class="text-wrap"> <em>'일상의 걸음도 스포츠다!'</em>
					<span>SPORTS PERFORMANCE CENTER - RETURN TO PLAY!</span>
				</div>
			</li>
		</ul>
