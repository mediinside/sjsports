...
<div class="Wrap_layer"><!--// 전체를 감싸는 Wrap -->
	<div class="boxContent_layer">
		<div class="boxContentHeader">
			<span class="boxTopNav"><strong>스태프 등록</strong></span>
		</div>
		<form name="base_form" id="base_form" method="POST" action="?" enctype="multipart/form-data">
		<input type="hidden" name="mode" id="mode" value="DOCTOR_REG" />
		<input type="hidden" name="dr_clinic" id="dr_clinic" value="B" />
				...
				<div class="layerTable">
					<table class="table table-bordered">
						<tbody>
							...
							<tr>
								<th><input type="text" class="input_text" size="25" name="history_title" id="history_title" value="<?=$history_title?>" /></th>
								<td>
									<textarea name="dr_history" id="dr_history" style="width:98%; height:100px;  overflow:auto;" ></textarea>
								</td>
							</tr>
                            <tr>
								<th><input type="text" class="input_text" size="25" name="history_title2" id="history_title2" value="<?=$history_title2?>" /></th>
								<td>
									<textarea name="dr_history2" id="dr_history2" style="width:98%; height:100px; overflow:auto;" ></textarea>
								</td>
							</tr>
                            <tr>
								<th><input type="text" class="input_text" size="25" name="history_title3" id="history_title3" value="<?=$history_title3?>" /></th>
								<td>
									<textarea name="dr_history3" id="dr_history3" style="width:98%; height:100px; overflow:auto;" ></textarea>
								</td>
							</tr>
                            <tr>
								<th><input type="text" class="input_text" size="25" name="history_title4" id="history_title4" value="<?=$history_title4?>" /></th>
								<td>
									<textarea name="dr_history4" id="dr_history4" style="width:98%; height:100px; overflow:auto;" ></textarea>
								</td>
							</tr>		
							<tr>
								<th><input type="text" class="input_text" size="25" name="history_title5" id="history_title5" value="<?=$history_title5?>" /></th>
								<td>
									<textarea name="dr_history5" id="dr_history5" style="width:98%; height:100px; overflow:auto;" ></textarea>
								</td>
							</tr>		
							<tr>
								<th><input type="text" class="input_text" size="25" name="history_title6" id="history_title6" value="<?=$history_title6?>" /></th>
								<td>
									<textarea name="dr_history6" id="dr_history6" style="width:98%; height:100px; overflow:auto;" ></textarea>
								</td>
							</tr>		
							<tr>
								<th><input type="text" class="input_text" size="25" name="history_title7" id="history_title7" value="<?=$history_title7?>" /></th>
								<td>
