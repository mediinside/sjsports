...
<div class="Wrap"><!--// 전체를 감싸는 Wrap -->
		...
		<div class="btnWrap">
			...
			<button onClick="layerPop('ifm_reg','./dr_reg.php', '100%', 900)"; class="btnSearch btnRight">의료진 등록</button>
		</div>
						...
						<tbody>
							...
							<?
								...
								for ($i = 0 ; $i < $data_list_cnt ; $i++) {
									...
									$edit_btn = $C_Button -> getButtonDesign('type2','수정',0,"layerPop('ifm_reg','./dr_edit.php?dr_idx=" . $dr_idx. "', '100%', 900)", 50,'');	
								...
								?>
										<tr id="<?=$dr_idx?>">
											...
											<td><?=$dr_img?></td>
											<!--td><?=$dr_img1?></td-->
                                            <td><?=$GP -> DOCTOR_POSITION[$dr_position]?></td>
