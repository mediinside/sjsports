...
(function($){
	...
	var _process = function(e, data, options) {
		...
		for (var i=options.offset; i<feeds.entries.length; i++) {
			...
			//rowArray[rowIndex]['html'] = '<a href="'+ options.linkredirect + feedLink +'" title="View this feed at '+ feeds.title +'"><strong>'+ entry.title +'</strong></a>'
			...
			if (options.content) {
				...
				content = _string_cut(content, 60,"...");
				
				if (options.linkredirect) feedLink = encodeURIComponent(feedLink);
				rowArray[rowIndex]['html'] = '<li class="facebook"><a href="'+ options.linkredirect + feedLink +'" title="View this feed at '+ feeds.title +'"><strong>'+ content +'</strong>'
				
				if (options.date && pubDate) {
					rowArray[rowIndex]['html'] += ''+ pubDate +'</a></li>'
				}else{
					rowArray[rowIndex]['html'] += ''+ pubDate +'</a></li>'
				}
			}
	...
	var _string_cut = function(str, len, tail) {
